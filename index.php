...
file_get_contents("http://banpayapraischool.ac.th/cron/ins_linebot.php?msg=".(ereg_replace('[[:space:]]+', '', trim($_msg)))."&user_id=".$userId."&usernames="(ereg_replace('[[:space:]]+', '', trim("นายสุขสันต์ สอนนวล"))));
